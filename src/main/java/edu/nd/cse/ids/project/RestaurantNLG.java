...
public class RestaurantNLG
{
    ...
    public static void main(String[] args)
    {
				...
				System.out.println("How much would you like to spend per person? Please use numbers.");
				String priceString = scanner.nextLine();
				priceString = priceString.replaceAll("[^0-9]+", " ");
				List<String> priceList = Arrays.asList(priceString.trim().split(" "));
				Float avgprice = Float.parseFloat(priceList.get(0));
				...
				List<String> ratingList = Arrays.asList(ratingString.trim().split(" "));
				Float minrating = Float.parseFloat(ratingList.get(0));
