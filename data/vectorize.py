...
if __name__ == '__main__':
    ...
    for rid, rname, city, add, cuisine, cost, currency, book, delivery, priceRange, rating, ratingText, vote in zip(rids, rnames, cities, adds, cuisines, costs, currencys, books, deliverys, priceRanges, ratings, RatingTexts, Votes):
    ...
    with open('zomato_vectors.txt', 'w') as f:
        for item in ndat:
            f.write("--".join(item))
            f.write("\n")
